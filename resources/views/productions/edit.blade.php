    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Update Production Raw Materials Report
                ...
                <div class="table-responsive">
                    <form method="post" action="#" enctype="multipart/form-data">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            @csrf
                            @method('patch')
                            @foreach($productions as $d)
                                <tr>
                                    <th>Production No.</th>
                                    <td><input type="text" class="form-control" value="{{ $d->ptn_no }}" name="barcode_id[]" id="barcode_id" readonly/>
                                ...
                                <tr style="background-color: #023784; color: white;">
                                    <th>Raw Material</th>
                                    <td><input type="text" class="form-control" value="{{ $d->rawmaterial_id }}" name="rawmaterial_id[]" id="rawmaterial_id" readonly/>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" value="{{ $d->qty_collected }}" name="qty_collected[]" id="qty_collected" readonly/>
                                ...
                                <tr>
                                    <th>Quantity Returned</th>
                                        <td>
                                        <input type="text" class="form-control" value="{{ $d->qty_returned }}" name="qty_returned[]" id="qty_returned" readonly/>
                                ...
                                <tr>
                                    <th>Quantity Used</th>
                                    <td><input type="text" class="form-control" value="{{ $d->qty_used }}" name="qty_used[]" id="qty_used"/>
                                ...
                                <tr>
                                    <th>Waste</th>
                                    <td><input type="text" class="form-control" value="{{ $d->waste }}" name="waste[]" id="waste"/>
                                        @if ($errors->has('waste'))
                                ...
                                <tr>
                                    <th>Remarks</th>
                                    <td><input type="remarks" class="form-control" value="{{ $d->remarks }}" name="remarks[]" id="remarks"/>
