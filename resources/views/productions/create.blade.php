                ...
                <div class="table-responsive">
                    <form method="post" action="{{ route('productions.store') }}" enctype="multipart/form-data">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                <th>Production No.</th>
                                <td><input type="text" class="form-control" value="{{ $rawmatscollected->barcodes->ptn_no }}" name="barcode_id" id="barcode_id" readonly/>
                            ...
                            <tr>
                                <th>Raw Material</th>
                                <td><input type="text" class="form-control" value="{{ $rawmatscollected->rawmaterial }}" name="rawmaterial_id" id="rawmaterial_id" readonly/>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" value="{{ $rawmatscollected->qty }}" name="qty_collected" id="qty_collected" readonly/>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" value="{{ $rawmatsreturned }}" name="qty_returned" id="qty_returned" readonly/>
