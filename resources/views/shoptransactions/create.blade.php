...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['shoptransactions.store']]) !!}
    @csrf
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">New Shop Transaction
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 form-group">
                        ...
                        {!! Form::date('date_of_trx', old('date_of_trx'), ['class' => 'form-control', 'placeholder' => '']) !!}
                        <p class="help-block"></p>
