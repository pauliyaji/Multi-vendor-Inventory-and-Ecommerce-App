        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row input-daterange col-md-12">
                    <form method="post" action="reports.salessearch" class="col-md-12" style="display: flex;">
                        @csrf
                        <div class="row g-3">
                    ...
                    <a href="{{ route('exportsales') }}" class="btn btn-primary m-2 me-1">Export Data</a>

                    <br/>
                </div>
                @include('excelfiles.sales_table')
            </div>
        </div>
        <!-- Modal -->
