    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Raw Materials Supply Summary

                </h6>
            </div>
            <div class="card-body">
                <div class="row input-daterange col-md-12">
                    <form method="post" action="reports.rawmatsearch" class="col-md-12" style="display: flex;">
                        @csrf
                        ...
                        <div class="col-md-4 mt-1">
                            ...
                            <a href="{{ route('reports.rawmaterials') }}"><btn class="btn btn-info btn-sm">Refresh</btn></a>
                        </div>
                    </form>
                    <a href="{{ route('exportsupply') }}" class="btn btn-primary m-2 me-1">Export Data</a>
                    <br/>
                </div>
            @include('excelfiles.supplytable')
            </div>
        </div>
        <!-- Modal -->
