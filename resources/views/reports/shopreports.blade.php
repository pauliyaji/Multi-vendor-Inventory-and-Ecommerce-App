                            ...
                            <div class="card-body text-left p-0 m-0" style="color: #1a1e21;">
                                ...
                                @foreach($production as $ptn)
                                    <div class="row" style="margin: 10px;">
                                        ...
                                        <div class="col-md-6">
                                            <h6 style="font-weight: bold; color:#757373;">{{ $ptn->total_qty }} nos.</h6>
                                        </div>
                        ...
                        <div class="card bg-light text-dark">
                            ...
                            <div class="card-body text-left" style="color: #1a1e21;">
                                ...
                                @foreach($stockSales as $shop)
                                    <div class="row" style="margin: 10px;">
                                        <div class="col-md-6">
                                            <h6 style="font-weight: bold; color:#757373;">{{ $shop->products->name }}</h6>
                                        </div>
                                        <div class="col-md-6">
                                            <h6 style="font-weight: bold; color:#757373;">{{ $shop->qty }} nos. <span style="font-style: italic; color: green;">Sold</span></h6>
                                        </div>
                                    </div>
                                    @endforeach
                                    </p>
