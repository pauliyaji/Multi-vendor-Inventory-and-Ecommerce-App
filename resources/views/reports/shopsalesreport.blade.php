        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row input-daterange col-md-12">
                    <form method="post" action="reports.shopsalessearch" class="col-md-12" style="display: flex;">
                        @csrf
                        <div class="row g-3">
                            ...
                            <div class="col-sm-7 m-1">
                                ...
                                <a href="{{ route('reports.shopsalesreport') }}">
                                    <btn class="btn btn-info btn-sm">Refresh</btn></a>
                            </div>
                        </div>

                    </form>
                    <a href="{{ route('exportshopsales') }}" class="btn btn-primary m-2 me-1">Export Data</a>

                    <br/>
                </div>
                @include('excelfiles.shopsales_table')
            </div>
        </div>
        <!-- Modal -->
