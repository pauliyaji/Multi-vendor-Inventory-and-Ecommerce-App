...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['rawmaterials.update', $data->id]]) !!}
    @csrf
    @method('patch')
                ...
                @endif
                        ...
                        <div class="col-md-12 col-xs-12 form-group">
                            ...
                            <select class="form-control"
                                ...
                                @foreach($units as $unit)
                                    <option @if($data->unit_of_measure_id==$unit->id) selected @endif
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 form-group">
                            ...
                            {!! Form::text('unit_price', $data->unit_price, ['class' => 'form-control', 'placeholder' => '']) !!}
                            <p class="help-block"></p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 form-group">
                            ...
                            {!! Form::text('re_order', $data->re_order, ['class' => 'form-control', 'placeholder' => '']) !!}
                            <p class="help-block"></p>
