...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['barcodes.update', $data->id]]) !!}
    @csrf
    @method('patch')
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 form-group">
                        ...
                        {!! Form::date('date_of_production', $data->date_of_production, ['class' => 'form-control', 'placeholder' => '']) !!}
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 form-group">
                        ...
                        {!! Form::text('output_qty', $data->output_qty, ['class' => 'form-control', 'placeholder' => '']) !!}
                        <p class="help-block"></p>
