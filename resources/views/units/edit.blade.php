...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['units.update', $data->id]]) !!}
    @csrf
    @method('patch')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Update Unit
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12 form-group">
                        ...
                        {!! Form::text('unit', $data->unit, ['class' => 'form-control', 'placeholder' => '']) !!}
